...
const handler = async (m, {conn, command, args, text, usedPrefix}) => {
  ...
  try {
    ...
    const texto1 = `╭࣭࣭࣭࣭࣭࣭ٜ۫┄̸࣭࣭࣭࣭࣭ٜ۫☪︎︎︎̸⃘̸࣭ٜ࣪࣪࣪۬◌⃘۪֟፝֯۫۫︎⃪𐇽۫۬《■》⃘⃪۪֟፝֯۫۫۫۬◌⃘࣭ٜ࣪࣪࣪۬☪︎︎︎︎̸┄̸࣭࣭࣭࣭࣭ٜ۫┄࣭࣭࣭۫┄̸࣭࣭࣭࣭࣭ٜ۫┄࣭࣭࣭۫┄̸࣭۫┄̸࣭࣭࣭࣭࣭ٜ۫┄̸࣭۫┄̸࣭࣭࣭࣭࣭ٜ۫┄࣭࣭࣭۫╮
┊┃ ➢ ⌈🔊 YOUTUBE 🔊⌋
┊┣┅ ━━━━━━━━━━━━ ┅ ━
...
┊┃ ➢ *Link:* ${yt_play[0].url}
┊┣┅ ━━━━━━━━━━━━ ┅ ━
┊┃ ➢ *_Enviando ${additionalText},_*
┊┃ *_aguarde un momento．．．_*
┊┣┅ ━━━━━━━━━━━━ ┅ ━
┊┃ ➢𝙱𝚢: 𝙽𝚒𝚐𝚛𝚘𝚖𝚊𝚗𝚝𝚎𝙱𝚘𝚝-𝙼𝙳
