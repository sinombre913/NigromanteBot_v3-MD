...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: '★𝙱𝚢: 𝙽𝚒𝚐𝚛𝚘𝚖𝚊𝚗𝚝𝚎𝙱𝚘𝚝-𝙼𝙳»', body: null, thumbnail: imagen1, sourceUrl: 'https://whatsapp.com/channel/0029VaWcBCgCXC3NZU4GVA2c'}, mentionedJid: [m.sender]}}}, aa);
